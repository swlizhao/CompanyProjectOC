...
- (BaseCollectionView *)rightCollectionView {
    if (!_rightCollectionView) {
        UICollectionViewFlowLayout * layout = [[UICollectionViewFlowLayout alloc]init];
        layout.sectionInset = UIEdgeInsetsMake(0, 0, 0, 5);
        layout.minimumLineSpacing = 0;
        layout.minimumInteritemSpacing = 0;
        _rightCollectionView = [[BaseCollectionView alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_leftTableView.frame) + 5, 0, self.bounds.size.width - CGRectGetMaxX(_leftTableView.frame) - 5, self.bounds.size.height) collectionViewLayout:layout];
